...
public:
    ...
    std::filesystem::path FetchAndSaveAsset(const std::string& baseUrl, const std::string& baseTempDir, const std::string& relativePath) const;
    void saveAssetContentToFile(const std::string& assetContent, const std::string& filePath) const;
